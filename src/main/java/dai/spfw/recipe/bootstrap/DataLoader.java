package dai.spfw.recipe.bootstrap;

import dai.spfw.recipe.domain.*;
...
public class DataLoader implements CommandLineRunner {
    ...
    private final UnitOfMsRepo unitOfMeasureRepository;

    public DataLoader(CategoryRepo categoryRepository, RecipeRepo recipeRepository, UnitOfMsRepo unitOfMeasureRepository) {
    ...
    private List<Recipe> loadRecipies(){
        System.out.println("Inside List<Recipe> loadRecipies");
        ...
        if(!eachUomOptional.isPresent()){
            ...
            um1 = new UnitOfMeasure();
            um1.setDescription("Each");
            unitOfMeasureRepository.save(um1);
        }
        eachUomOptional = unitOfMeasureRepository.findByDescription("Each");

        Optional<UnitOfMeasure> tableSpoonUomOptional = unitOfMeasureRepository.findByDescription("Tablespoon");
        if(!tableSpoonUomOptional.isPresent()){
            um1 = new UnitOfMeasure();
            um1.setDescription("Tablespoon");
            unitOfMeasureRepository.save(um1);
        }
        tableSpoonUomOptional = unitOfMeasureRepository.findByDescription("Tablespoon");

        Optional<UnitOfMeasure> teaSpoonUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");
        if(!teaSpoonUomOptional.isPresent()){
            um1 = new UnitOfMeasure();
            um1.setDescription("Teaspoon");
            unitOfMeasureRepository.save(um1);
        }
        teaSpoonUomOptional = unitOfMeasureRepository.findByDescription("Teaspoon");

        Optional<UnitOfMeasure> dashUomOptional = unitOfMeasureRepository.findByDescription("Dash");
        if(!dashUomOptional.isPresent()){
            um1 = new UnitOfMeasure();
            um1.setDescription("Dash");
            unitOfMeasureRepository.save(um1);
        }
        dashUomOptional = unitOfMeasureRepository.findByDescription("Dash");

        Optional<UnitOfMeasure> pintUomOptional = unitOfMeasureRepository.findByDescription("Pint");
        if(!pintUomOptional.isPresent()){
            um1 = new UnitOfMeasure();
            um1.setDescription("Pint");
            unitOfMeasureRepository.save(um1);
        }
        pintUomOptional = unitOfMeasureRepository.findByDescription("Pint");

        Optional<UnitOfMeasure> cupsUomOptional = unitOfMeasureRepository.findByDescription("Cup");
        if(!cupsUomOptional.isPresent()){
            um1 = new UnitOfMeasure();
            um1.setDescription("Cup");
            unitOfMeasureRepository.save(um1);
        }
        cupsUomOptional = unitOfMeasureRepository.findByDescription("Cup");
        ...
        if(!americanCategoryOptional.isPresent()){
            ctg = new Category();
            ctg.setDescription("American");
            categoryRepository.save(ctg);
        }
        americanCategoryOptional = categoryRepository.findByDescription("American");

        Optional<Category> mexicanCategoryOptional = categoryRepository.findByDescription("Mexican");
        if(!mexicanCategoryOptional.isPresent()){
            ctg = new Category();
            ctg.setDescription("Mexican");
            categoryRepository.save(ctg);
        }
        mexicanCategoryOptional = categoryRepository.findByDescription("Mexican");
